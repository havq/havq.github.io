/* /js/Codebox.min.js */ ! function() {
    ...
    for (let t = 0; t < d.length; t++) {
        ...
        let e = a.querySelector(".prVw"),
            n = a.querySelector(".prDl"),
            s = a.querySelector(".prCp"),
        ...
        null !== e && e.addEventListener("click", () => {
            ...
            window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveOrOpenBlob(blobObject, fileName) : (e = window.URL.createObjectURL(e), window.open(e, "_blank"), window.URL.revokeObjectURL(e))
        }), null !== n && n.addEventListener("click", () => {
            n.disabled = !0;
            let e = c;
            a.classList.add("pnd", "str"), o.innerHTML = 0 !== c ? "Please wait " + e + "s..." : "Please wait...";
            let t = setInterval(() => {
                0 !== c && --e, 0 !== c && (o.innerHTML = "Please wait " + e + "s..."), e <= 0 && (clearInterval(t), setTimeout(() => {
                    o.innerHTML = "Downloading...", setTimeout(() => {
                        a.classList.remove("pnd"), a.classList.add("dwn"),
                            function(e, t, a) {
                                if (a = "string" == typeof a ? a : "text/plain", t = "string" == typeof t ? t : "File_" + (new Date).getTime() + ".txt", e) {
                                    if (a = new Blob([e], {
                                            type: a
                                        }), navigator.msSaveBlob) return navigator.msSaveBlob(a, t); {
                                        a = window.URL.createObjectURL(a);
                                        let e = document.createElement("a");
                                        e.classList.add("hidden"), e.href = a, e.download = t, document.body.appendChild(e), e.click(), e.remove(), window.URL.revokeObjectURL(a)
                                    }
                                }
                            }(L, l.replace(/\./g, "").replace(/ /g, "_") + r, "text/plain"), o.innerHTML = "Download started...", setTimeout(() => {
                                a.classList.remove("dwn", "str"), n.disabled = !1
                            }, 3e3)
                    }, 2e3)
                }, 1e3))
            }, 1e3)
            ...
            t.selectNodeContents(w), e.removeAllRanges(), e.addRange(t), document.execCommand("copy"), e.removeAllRanges(), s.disabled = !0, a.classList.add("cpd"), setTimeout(function() {
                a.classList.remove("cpd"), s.disabled = !1
            }, 3e3)
        })
    }
}();
